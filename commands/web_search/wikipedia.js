...
module.exports = { // Update To Your Handler
    ...
    execute: async(message, args, client) => { // Update To Your Handler
        ...
        try {
            ...
            return message.reply('Provide a **valid** or **existing** query to search.') // If Searched Topic Is Not Available
        }
    }
}